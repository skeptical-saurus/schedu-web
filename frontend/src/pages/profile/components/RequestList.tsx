...
const RequestList: React.FC<Props> = ({ appointments }) => {
  return (
    <>
          ...
          {appointments?.map(apm => (            
            <div className='grid grid-cols-6 py-3 border-b'>
              ...
              <div className='col-span-2 flex items-center justify-end ml-8'>
                ...
                <button className='group w-8 h-8 flex border border-emerald-500 bg-emerald-500 hover:border-emerald-600 hover:bg-emerald-600 ml-3 duration-100 rounded-full'>
